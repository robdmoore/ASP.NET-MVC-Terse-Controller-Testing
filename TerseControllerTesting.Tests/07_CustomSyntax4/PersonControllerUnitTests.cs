...
namespace TerseControllerTesting.Tests._07_CustomSyntax4
{
    ...
    class PersonControllerUnitTests
    {
        ...
        public void Setup()
        {
            ...
            _controller = ControllerTest.Test(_autoMock.Resolve<PersonController>());
            _person.Id = 0;
        }
        ...
        {
            _controller.Index().ShouldRenderDefaultView().WithModel<IEnumerable<Person>>();
        }
        ...
        {
            _controller.WithModelErrors().Create(_person)
